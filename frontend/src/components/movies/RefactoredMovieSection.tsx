...
export const RefactoredMovieSection = forwardRef<MovieSectionHandle, {}>(
  (props, ref) => {
          ...
          {mediaSection.searchResults.map((movie) => (
            <Box key={`search-${movie.id}`} sx={{ cursor: "pointer" }}>
              <MovieCard
                ...
                onAddToWatchlist={() =>
                  mediaSection.handleAddToWatchlist(movie)
                }
              />
            </Box>
          ))}
          ...
          {mediaSection.watchlistItems.map((movie) => (
            ...
            >
              <MovieCard
                ...
                onLike={() =>
                  mediaSection.handleWatchlistFeedback(movie, "like")
                }
                onDislike={() =>
      ...
      <MediaSectionLayout
        ...
        onLikeSuggestion={() => {
          ...
          if (mediaSection.suggestedItem) {
            ...
            if (
              !mediaSection.savedItems.some((m) => m.id === updatedMovie.id)
            ) {
