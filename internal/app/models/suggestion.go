...
const (
	...
	StatusWatchlist SuggestionStatus = "watchlist" // Added to playlist/watchlist
)
...
func IsValidStatus(statusStr string) bool {
	...
	case StatusPending, StatusSkipped, StatusLiked, StatusDisliked, StatusAdded, StatusWatchlist:
		return true
	default:
		return false
	}
